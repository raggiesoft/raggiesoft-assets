...
This document serves as the master reference for all drop-in replacements for real-world copyrighted and trademarked entities within the fictional universe. Directive for the AI: use the real world brand and notes for context, but ALWAYS use the Fictional Equivalent when rendering content. If we ever come across copyrighted or trademarked words that do not have a Fictional Equivalent, we MUST add it to this document real quick before continuing to generate content.
...
### Supermarkets, Pharmacies & Big-Box Retail
...
### Hospitality, Venues & Landmarks

| Real-World Brand | Fictional Equivalent | Flagship Products / Notes |
| :--- | :--- | :--- |
| Hyatt Regency | Crown Regency | Luxury hotel chain. Specific notable location includes the property adjacent to the Convention Center CTS stop in Portland, Oregon. |
| Rose Garden (Moda Center) | Rose City Center | Major indoor multipurpose arena in Portland, Oregon, utilized for large-scale events and professional wrestling broadcasts. |
| Ruby Mountain (Real Location) | The Prospector's Keep | A highly fortified, 1890s timber-framed alpine resort operating as a sovereign family fortress in the North Cascades. |
| Ruby Mountain (Washington State) | Ruby Mountain (Preserved Location) | The actual, real-world geological foundation located on State Route 20. It serves as the physical anchor for the Vanguard's territory. |
| N/A (Original Fictional Creation) | The Prospector's Keep | A sovereign, 1890s timber-framed alpine fortress built *on top* of Ruby Mountain. Its massive scale and architecture are heavily inspired by the real-world Timberline Lodge. |
| Timberline Lodge (Mount Hood, OR) | The Highline Lodge | A historic mountain lodge located on Mount Hood. It exists as a completely separate, in-universe entity and has no operational ties to The Prospector's Keep. |
...
| Microsoft Software Suite | Quantum Suite | Includes WritePad, Calculation, Presentation, Organizer. Microsoft Bob = Quantum Robert. Encarta = Quantum Multimedia Encyclopedia. |
...
| Dell | Apex | The home computing division of the broader APEX Conglomerate. |
| Dell Latitude 110L | Apex Meridian 110L | An outdated, budget-tier consumer laptop utilized prior to the Clarity hardware upgrade. |
...
| Roxette / 1980s Pop-Rock | Neon Horizon | Fictional 1980s pop-rock act. Known for the holiday track *"Last December"* and the arena anthem *"Before the Distance"* (an exact drop-in replacement for Roxette's *"Listen to Your Heart"*). |
| *Original Canon* | The Stardust Engine | Original fictional band. In-universe lore dictates an active presence in the 1980s, including the release of their project *"Electric Color"* in 1987. |
